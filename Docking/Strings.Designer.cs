...
namespace WeifenLuo.WinFormsUI.Docking {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   查找类似 Indicate whether or not the status icon should be displayed. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Status icon displayed when ShowStatusIcon property is set to true. 的本地化字符串。
        /// </summary>
